...
* Соединение отправило N запросов и ожидает получение ответов на них, послу чего было отправлено еще более
65536 - N запросов.
* Соединение не ожидает ответа на запроса и отправило более 65536 запросов.
